...
(defun black (str &optional (output-stream t)) 
...
(defun red (str &optional (output-stream t)) 
...
(defun green (str &optional (output-stream t)) 
...
(defun yellow (str &optional (output-stream t)) 
...
(defun blue (str &optional (output-stream t)) 
...
(defun magenta (str &optional (output-stream t)) 
...
(defun cyan (str &optional (output-stream t)) 
...
(defun white (str &optional (output-stream t)) 
...
(defun gray (str &optional (output-stream t)) 
...
(defun bright-red (str &optional (output-stream t)) 
...
(defun bright-green (str &optional (output-stream t)) 
...
(defun bright-yellow (str &optional (output-stream t))
...
(defun bright-blue (str &optional (output-stream t)) 
...
(defun bright-magenta (str &optional (output-stream t)) 
...
(defun bright-cyan (str &optional (output-stream t)) 
...
(defun bright-white (str &optional (output-stream t)) 
